<?php 
//Fonction qui récupère le dernière référence dans la table user_order et renvoi la prochaine référence.
...
// fonction qui insère dans la table order_user, renvoi l'id insérer  
